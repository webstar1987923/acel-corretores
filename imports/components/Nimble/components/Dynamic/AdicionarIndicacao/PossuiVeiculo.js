    ...
    return (
      <label className="col-md-6">
        ...
        <label className="radio-inline control-label">
          <input type="radio" name="possuiVeiculos" defaultValue="sim" onChange={this._handleChange} />
          Sim
        </label>

        <label className="radio-inline control-label">
          <input type="radio" name="possuiVeiculos" defaultValue="não" onChange={this._handleChange} />
          Não
        </label>
