...
describe('SimpleSchema - required', function () {
  describe('normal', function () {
    ...
    it('invalid', function () {
      expectRequiredErrorLength(requiredSchema, {}).toEqual(8);
  ...
  describe('modifier with $set', function () {
    ...
    it('invalid upsert', function () {
      expectRequiredErrorLength(requiredSchema, {
        $set: {},
      }, { modifier: true, upsert: true }).toEqual(8);
      ...
      }, { modifier: true, upsert: true }).toEqual(9);
      ...
      }, { modifier: true, upsert: true }).toEqual(7);
  ...
  describe('modifier with $set and $setOnInsert', function () {
    ...
    it('invalid upsert', function () {
      ...
      }, { modifier: true, upsert: true }).toEqual(5);
