// Um pequeno polyfill para Array.includes (node >= 7)
...
const SimpleSchema = require('./SimpleSchema/lib/main.js').default;
...
_.each(['insert', 'update'], (methodName) => {
